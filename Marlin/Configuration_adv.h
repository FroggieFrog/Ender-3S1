 ...
 */
// Depending on which pin is used to connect the fan on the new board, for example for PAx, just define #define E0_AUTO_FAN_PIN PAx in Configuration_adv.h.
// According to the new hardware schematic, assuming that PC0 is used to connect the throat fan, change to #define E0_AUTO_FAN_PIN PC0, when the throat temperature is greater than EXTRUDER_AUTO_FAN_TEMPERATURE the throat fan turns on --zy
...
//#define BEEP_ON_FEEDRATE_CHANGE
        ...
        // Avoid laser shine outside the platform when laser returns to zero/stop
